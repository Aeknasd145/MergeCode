<?php include("header.php"); 
	...
	while ($seo_settings_query_read = mysqli_fetch_array($seo_settings_query)) {
		...
		$desc 		= 	$seo_settings_query_read["desc"];
				...
				<div class="row justify-content-md-center mt-4">
					<div class="col-10" style="border: solid 1px grey;">
						<form action="" method="POST">
							...
							<div class="col-12" style="float: left; margin-top: 12px; padding-top: 15px; padding-bottom: 15px">
								<p>H Etiketi Uyumunuz: Uygun Gözüküyor</p>
							</div>
							<div class="col-6" style="float: left; margin-top: 12px; padding-top: 15px; padding-bottom: 15px">
								<p>Sayfa Açılış Hızınız (masaüstü): 5 Saniye</p>
							</div>		
							<div class="col-6" style="float: left; margin-top: 12px; padding-top: 15px; padding-bottom: 15px">
								<p>Sayfa Açılış Hızınız (mobil): 5 Saniye</p>
							</div>		
