<div id="omega">
  	<div id="omega-content">
		<nav>
    		<ul id="menu">
				...
				<div class="dropdown">
				  	<button class="btn" type="button" data-toggle="dropdown">
				    	<i class="fas fa-cogs" aria-hidden="true"></i><?php echo $lang["settings"];?>
				  	</button>
				  	<div class="dropdown-menu">
						<!--<a href="theme-settings.php" class="dropdown-item"><?php echo $lang["theme-settings"];?></a>-->
  	...
  	<i id="omega-button" class="fa fa-bars" aria-hidden="true"></i>
...
<script src="js/omega/omega.js"></script>